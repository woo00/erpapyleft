...
public class taapproveModel 
{
	...
	private String va_name;     // 휴가 이름
	private int use_date;       // 사용 휴가
	private int rleave;         // 이번 년도 총 사용 휴가
	private String use_loginID; // 사용자 이름
	private String va_state;    // 심사 여부
	private String dept_name;   // 부서명
	private String name; // 승인자
	private String email; // 승인자 email
	...
	public String getUse_loginID() {
		return use_loginID;
	}
	public void setUse_loginID(String use_loginID) {
		this.use_loginID = use_loginID;
	}
	public String getVa_state() {
		return va_state;
	}
	public void setVa_state(String va_state) {
		this.va_state = va_state;
	}
	public int getRleave() {
		return rleave;
	}
	public void setRleave(int rleave) {
		this.rleave = rleave;
	}
