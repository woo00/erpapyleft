...
public class YyRevenueController {
	 ...
	 * 년도별매출관리 초기화면 Vue
	 */
	@RequestMapping("/yyRevenueVue.do")
	public String yyRevenueVue(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
