...
public interface DvDao {
	...
	/** 지출결의 목록 조회(신청페이지) */
	public List<DvModel> dvList(Map<String, Object> paramMap);
//	카운트
...
//	파일등록
	public int dvFile(Map<String, Object> paramMap) throws Exception;
	
//	파일수정
	public int dvFileUpdate(Map<String, Object> paramMap) throws Exception;
	 
//	파일삭제
	public int dvFileDelete(Map<String, Object> paramMap) throws Exception;
